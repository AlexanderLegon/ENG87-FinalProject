...
//     List<Object[]> getTraineesByCourseId(int id);
    ...
    @Query(value = "SELECT t.first_name, t.last_name, q.quality_gate_status, t.trainee_id, c.course_name, q.quality_gate_date, q.trainer_feedback_1, q.trainer_feedback_2  FROM trainee t " +
