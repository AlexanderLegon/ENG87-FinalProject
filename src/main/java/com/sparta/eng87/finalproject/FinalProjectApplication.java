...
//            disciplineService.addDiscipline(new DisciplineEntity("C#SDET", 12));
            traineeService.addTrainee(new TraineeEntity("qwe", "asd", 1, Date.valueOf("2021-05-04")));
            traineeService.addTrainee(new TraineeEntity("dgfsgdsf", "dafghsfd", 2, Date.valueOf("2021-04-19")));
            traineeService.addTrainee(new TraineeEntity("George", "dafghsfd", 2, Date.valueOf("2021-05-10")));
            traineeService.addTrainee(new TraineeEntity("Karim", "dafghsfd", 2,  Date.valueOf("2021-04-12")));
            traineeService.addTrainee(new TraineeEntity("Tom", "dafghsfd", 2,  Date.valueOf("2021-04-16")));
            traineeService.addTrainee(new TraineeEntity("Thomas", "dafghsfd", 2,  Date.valueOf("2021-04-22")));
            traineeService.addTrainee(new TraineeEntity("Alexander", "dafghsfd", 2,  Date.valueOf("2021-07-12")));
            traineeService.addTrainee(new TraineeEntity("Alex L", "dafghsfd", 2,  Date.valueOf("2021-05-13")));
            traineeService.addTrainee(new TraineeEntity("Alex C", "dafghsfd", 2,  Date.valueOf("2021-07-13")));
            traineeService.addTrainee(new TraineeEntity("Jian", "dafghsfd", 2,  Date.valueOf("2021-04-01")));
            traineeService.addTrainee(new TraineeEntity("Adrian", "dafghsfd", 2,  Date.valueOf("2021-03-30")));
